...
**It buys no vendor call, and that is structural — but it is NOT free.** Two claims were conflated
here and only one of them survives.

*What survives, the SPEND claim.* Stage 2's keyless ceiling is
...
`maxCandidatesScored` does not move (captain decision 339a). So no request, credit or wall-clock
ceiling moves, and the arm cannot cause one extra vendor call.
