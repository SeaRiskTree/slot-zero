...
- **An UNREADABLE flag is kept and counted, not read as non-mayhem and not dropped.** The flag's
  ...
  choice auditable: equal to `tokens` means no mayhem evidence touched that rate at all.
